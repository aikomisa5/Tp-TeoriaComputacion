...
public class TestEjercicio1a_producciones_e {
	...
	@Test
	public void testGramatica_1_eliminacion_chequeo_producciones() throws FileNotFoundException, BadFileException {

		System.out.println("--------------------------");
		System.out.println("testGramatica_1_eliminacion");
		System.out.println("--------------------------");
		...
		assertTrue(checkProducciones(gramatica.getProducciones()));
	}

	private boolean checkProducciones(List<Produccion> producciones) {
		boolean valida = true;

		List<Produccion> produccionesSolucion = getProducciones();
	...
	private List<Produccion> getProducciones() {
	...
	@Test
	public void testGramatica_3_EliminarE() throws FileNotFoundException, BadFileException {

		System.out.println("--------------------------");
		System.out.println("testGramatica_3_EliminarE");
		System.out.println("--------------------------");
